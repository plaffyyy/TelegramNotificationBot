...
@SpringBootTest(
  classes = {
    ...
    KafkaValidMessageTest.TestKafkaListener.class  
},
  properties = {
...
public class KafkaValidMessageTest {
    ...
    void validMessageIsProcessed() throws InterruptedException {
        ...
        assertEquals(request.description(), received.get().description(), "Received message should have the same description");
